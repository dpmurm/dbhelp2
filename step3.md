...
Большая гибкость приложения на [MVC](https://ru.wikipedia.org/wiki/Model-View-Controller) и является самым главным плюсом к его использованию. Для себя я отметил следующие вещи:
...
![9f5cf1ea7bac6e3cacf727d5b6ad87b7](/images/step3/9f5cf1ea7bac6e3cacf727d5b6ad87b7.png)
...
![84f7f1c8f38b709f41be8260022334ab](/images/step3/84f7f1c8f38b709f41be8260022334ab.JPG)
...
В Yii контроллером называется класс наследуемый от [CController](http://www.yiiframework.com/doc/api/1.1/CController) или дочернего от него. Сам контроллер у нас занимается следующими действиями:
...
Модель это класс для работы приложения с базой. Для каждой таблицы с которой предстоит работать — создается своя модель (в Yii это класс наследуемый от [CModel](http://www.yiiframework.com/doc/api/1.1/CModel) или производного от него).
